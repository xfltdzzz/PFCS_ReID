...
from PFCS.models.cm import ClusterMemory_teacher
from PFCS.trainers import Trainer_teacher
...
def create_model(args):
    model = models.create(args.arch, num_features=args.features, norm=True, dropout=args.dropout,
                          num_classes=100, pooling_type=args.pooling_type)
    # use CUDA
    model.cuda()
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        del cluster_loader, features, features_up, features_down,features_mix, distribution_h_dict,distribution_g_dict,distribution_l_dict
    ...
    checkpoint = load_checkpoint(osp.join(args.logs_dir, 'examples/model_best.pth.tar'))
